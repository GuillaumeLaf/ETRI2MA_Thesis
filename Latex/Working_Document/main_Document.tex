...
\newcommand{\waveletExp}[4]{\psi_{#1,#2}^{#4}(#3)}
\newcommand{\squaredWavelet}[3]{\waveletExp{#1}{#2}{#3}{2}}
\newcommand{\ACwavelet}[2]{\bm{\Psi}_{#1}(#2)}
\newcommand{\CCwavelet}[3]{\bm{\Psi}_{#1,#2}(#3)}
...
\newcommand{\locsum}[1]{\sum_{#1=0}^{T-1}}
\newcommand{\smoothsum}[1]{\sum_{#1=-M}^{M}}
...
\newcommand{\estimEigs}[2]{\widehat{\bm{V}}_{#1,#2}}
\newcommand{\estimInvEigs}[2]{\widehat{\bm{V}}_{#1,#2}^{-1}}
...
\newcommand{\R}[2]{\bm{R}_{#1,#2}}
\newcommand{\invR}[2]{\bm{R}_{#1,#2}^{-1}}
\newcommand{\estimR}[2]{\widehat{\bm{R}}_{#1,#2}}

\newcommand{\V}[2]{\bm{V}_{#1,#2}}
\newcommand{\invV}[2]{\bm{V}_{#1,#2}^{-1}}
\newcommand{\estimV}[2]{\widehat{\bm{V}}_{#1,#2}}

\newcommand{\estimCovFactorWav}[2]{\widehat{\bm{\Sigma}}_{#1,#2}^{F}}
...
\subfile{RotationMatrix}

\subfile{V_Matrix_Convergence}
